...
var name = "Alice";
console.log("Hello, ".concat(name, "!")); // "Hello, Alice!"
...
var arr1 = [1, 2, 3];
var arr2 = [].concat(arr1, [4, 5]); // Spread
...
// 🔹 Promise.finally()
fetchData().then(console.log)["finally"](function () {
...
// 🔹 Optional Chaining (?.)
var user = {};
console.log(user === null || user === void 0 || (_user$profile = user.profile) === null || _user$profile === void 0 ? void 0 : _user$profile.name); // undefined (No Error)

// 🔹 Nullish Coalescing (??)
console.log((_ref2 = null) !== null && _ref2 !== void 0 ? _ref2 : "Default"); // "Default"
console.log((_ = 0) !== null && _ !== void 0 ? _ : "Default"); // 0

// ================== ES12 (2021) Features ==================

// 🔹 Numeric Separators (_ for readability)
var budget = 1000000; // 1000000
console.log(budget);
